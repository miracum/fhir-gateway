...
| SERVICES_KAFKA_PRODUCEONLY_ENABLED                    | Enable writing FHIR resources to a Kafka cluster when receiving them from API instead reading from Kafka                                                                                                                                                                                                                             | false                                     |
| SERVICES_KAFKA_PRODUCEONLY_OUTPUT_TOPIC               | Name of the topic where resources received from API should be written to                                                                                                                                                                                                                                                             | fhir.gateway.ouput                        |
